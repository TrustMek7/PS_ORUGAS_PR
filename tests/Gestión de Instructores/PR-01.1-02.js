...
const instructores = new SharedArray('instructores', function() {
  try {
    const contenido = open('./instructores_sin_acentos.txt');
...
export function handleSummary(data) {
  ...
  console.log('\n' + '═'.repeat(79));
  console.log('  📘 PR-01.1-02: CARGA MASIVA DE INSTRUCTORES - MÚLTIPLES USUARIOS');
  ...
  console.log(`  📋 NOTA: Prueba de estrés con 100 usuarios concurrentes`);
  console.log('═'.repeat(79) + '\n');
